        ...
        <div className="left__container">
          <div className="menu">
            ...
            <div className="menu__wrap">
              {titles.map(({title, color}) => <Selecter title={title} color={color} />)}
            </div>
              ...
              <div className="todo__wrap">
                <div className="todo__item">
                  <label>
                    ...
                    <span className="todo__text">Вынести мусор</span>
                  </label>
                ...
                <div className="todo__item">
                  <label>
                    <input type="checkbox" />
                    <span className="todo__checkbox"></span>
                    <span className="todo__text">Вынести мусор и еще кое-что очень длинное как разтоки и потом сделать еще</span>
                  </label>
                  <span className="icon-remove">
                    <svg width="22" height="22" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
